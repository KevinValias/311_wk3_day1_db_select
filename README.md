...
--Definitely easier managing all the information with mySQL. 
* What about when the dataset gets larger?
--Still think it will be just as easy with larger data as theres a way to limit the information your seeing with pulling just what you need when you need it.